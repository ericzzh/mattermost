...
# ZZH Del Begin //we don't need plugins
...
# 		done; \
# 	done
# ZZH Del End //we don't need plugins


	@# ----- PLATFORM SPECIFIC -----
# ZZH Del Begin // We don't need windows and osx package
# 	@# Make osx package
# 	@# Copy binary
# ifeq ($(BUILDER_GOOS_GOARCH),"darwin_amd64")
...
# 	rm -f $(DIST_PATH)/prepackaged_plugins/*
# ZZH Del End // We don't need windows and osx package
...
#          ZZH Del Begin // we don't need these prepackaged_plugins AND we don't need to tar
# 	 @# Prepackage plugins
# 	 @for plugin_package in $(PLUGIN_PACKAGES) ; do \
# 	 	ARCH="linux-amd64"; \
# 	 	cp tmpprepackaged/$$plugin_package-$$ARCH.tar.gz $(DIST_PATH)/prepackaged_plugins; \
...
#          ZZH Del End // we don't need these prepackaged_plugins AND we don't need to tar

#       ZZH Add, to be convienent make docker image
	cp ./build/Dockerfile $(DIST_ROOT)/
	cp ./build/entrypoint.sh $(DIST_ROOT)/
